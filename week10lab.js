...
//Answer: class , id, css, styles, values, properites, anything that you can do in HTML you can achieve with JS using DOM.
...
//Answer: I prefer to use CSS other than JS
...
myTableRow.append(myTdName)
myTableRow.append(myTdEmail)

document.body.append(myTable)

myTable.style.border = '3px dotted black'
...
//Answer: can be helpful by using event listeners.
...
//Question: What other event listeners are there? mouseup, mousedown, onmouseover, mousedown, mousemove, scroll
